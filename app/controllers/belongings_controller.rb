class BelongingsController < ApplicationController
  ...
  def create
    ...
    redirect_to community_applies_url(@belonging.community), notice: "「#{@belonging.user.username}」が、グループ：#{@belonging.community.name}へ加入しました。"
  end
  ...
  def destroy
    ...
    redirect_to community_url(@comminity), notice: "グループ「#{@comminity.name}」を退会しました。"
  end
